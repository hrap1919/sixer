...
On the picture above the cell marked by "6" is being pressed. Two from the six mines are already found (marked by "X"). The remaining four are hidden among the seven cells, these cells are marked by white "4" on the grey background.
